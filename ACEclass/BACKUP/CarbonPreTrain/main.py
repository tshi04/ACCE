...
parser.add_argument('--data_dir', default='../data/imdb_data', 
                    help='data dir')
parser.add_argument('--file_vocab', default='vocab.json',
...
parser.add_argument('--base_model_dir', default='../model', help='---')
...
parser.add_argument('--review_max_lens', type=int, default=300, 
                    help='max length documents.')
parser.add_argument('--hidden_size', type=int, default=512,
                    help='embedding dimension')
parser.add_argument('--factor_size', type=int, default=64,
                    help='factor dimension')
# CNN coefficient
parser.add_argument('--kernel_size', type=int, default=3, 
                    help='---')
parser.add_argument('--n_channels', type=int, default=8,
                    help='number of channels')
parser.add_argument('--n_layers', type=int, default=128,
                    help='number of layers')
# dropout
parser.add_argument('--drop_rate', type=float, default=0.1, 
                    help='dropout.')
# scheduler
parser.add_argument('--lr_schedule', type=str2bool, default=False, 
