...
from ACEclass.model_base_bert_tokenizer import \
    modelClassificationBaseBertToken
from LeafNATS.modules.attention.attention_self import AttentionSelf
from LeafNATS.modules.encoder.encoder_transformer import TransformerEncoder
...
class modelClassification(modelClassificationBaseBertToken):
    ...
    def build_models(self):
        ...
        self.train_models['encoder'] = TransformerEncoder(
            self.args.emb_size, 
            self.args.n_heads, 
            self.args.n_layers, 
            self.args.drop_rate,
