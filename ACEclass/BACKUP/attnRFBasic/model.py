...
from ACEclass.model_base_bert_tokenizer import modelClassificationBaseBertToken
from LeafNATS.modules.attention.attention_self import AttentionSelf
from LeafNATS.modules.encoder.encoder_transformer import TransformerBasic
from LeafNATS.modules.embedding.bert_embedding import BertEmbeddings
...
class modelClassification(modelClassificationBaseBertToken):
    ...
    def build_models(self):
        ...
        Build all models.
        '''
        self.train_models['embedding'] = BertEmbeddings(
        ...
        self.train_models['encoder'] = TransformerBasic(
            self.args.emb_size,
            self.args.n_heads,
            self.args.n_layers,
            self.args.drop_rate,
